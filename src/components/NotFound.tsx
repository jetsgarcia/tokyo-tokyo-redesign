...
export default function NotFound() {
  return (
    <div className="grid h-[calc(100vh-230px)] place-items-center text-center">
      <div className="flex flex-col items-center space-y-6 px-16">
        <svg
          version="1.1"
          id="_x32_"
        ...
        <div className="space-y-1">
          ...
          <h1 className="text-lg font-medium"> We can't find that page.</h1>
          <p className="text-sm">
